window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function buildBridgeMigrationCommand(targetPreset, summary, lang) {
...
`;
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								"Preparing editable handoff · 正在生成可编辑交接 · ",
								seconds,
								"s"
							]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: "Source stays untouched · 原会话保持不动"
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		function PreviewCard({ card, execute, openSession, sessionId }) {
			...
			const confirm = async () => {
				...
				try {
					const result = parseBridgeCard(await execute(sessionId, buildBridgeMigrationCommand(card.targetPreset, summary, card.lang)));
